...
public class ExaminationServiceImpl implements ExaminationService {
    ...
    @Autowired
    public ExaminationServiceImpl(DiagnosisRepository diagnosisRepository, ExaminationRepository examinationRepository, UserRepository userRepository, ModelMapper modelMapper) {
